{
  A slightly patched version of libxml2.pas that works in FPC.
  Original version: http://sourceforge.net/projects/libxml2-pas/
}
...
type
      ...
      attributeDeclSAXFunc = procedure  (ctx: Pointer; elem: xmlCharPtr; fullname: xmlCharPtr; type_: Longint; def: Longint; defaultValue: xmlCharPtr; tree: xmlEnumerationPtr); cdecl;
        attributeDeclSAXFuncPtr = ^attributeDeclSAXFunc;

      attributeSAXFunc = procedure  (ctx: Pointer; name: xmlCharPtr; value: xmlCharPtr); cdecl;
        attributeSAXFuncPtr = ^attributeSAXFunc;

      cdataBlockSAXFunc = procedure  (ctx: Pointer; value: xmlCharPtr; len: Longint); cdecl;
        cdataBlockSAXFuncPtr = ^cdataBlockSAXFunc;

      charactersSAXFunc = procedure  (ctx: Pointer; ch: xmlCharPtr; len: Longint); cdecl;
      ...
      elementDeclSAXFunc = procedure  (ctx: Pointer; name: xmlCharPtr; type_: Longint; content: xmlElementContentPtr); cdecl;
      ...
      endElementNsSAX2Func = procedure  (ctx: Pointer; localname: xmlCharPtr; prefix: xmlCharPtr; URI: xmlCharPtr); cdecl;
      ...
      entityDeclSAXFunc = procedure  (ctx: Pointer; name: xmlCharPtr; type_: Longint; publicId: xmlCharPtr; systemId: xmlCharPtr; content: xmlCharPtr); cdecl;
      ...
      externalSubsetSAXFunc = procedure  (ctx: Pointer; name: xmlCharPtr; ExternalID: xmlCharPtr; SystemID: xmlCharPtr); cdecl;
      ...
      ftpListCallback = procedure  (userData: Pointer; filename: PChar; attrib: PChar; owner: PChar; group: PChar; size: Cardinal; links: Longint; year: Longint; month: PChar; day: Longint; hour: Longint; minute: Longint); cdecl;
      ...
      ignorableWhitespaceSAXFunc = procedure  (ctx: Pointer; ch: xmlCharPtr; len: Longint); cdecl;
        ignorableWhitespaceSAXFuncPtr = ^ignorableWhitespaceSAXFunc;

      internalSubsetSAXFunc = procedure  (ctx: Pointer; name: xmlCharPtr; ExternalID: xmlCharPtr; SystemID: xmlCharPtr); cdecl;
      ...
      notationDeclSAXFunc = procedure  (ctx: Pointer; name: xmlCharPtr; publicId: xmlCharPtr; systemId: xmlCharPtr); cdecl;
        notationDeclSAXFuncPtr = ^notationDeclSAXFunc;

      processingInstructionSAXFunc = procedure  (ctx: Pointer; target: xmlCharPtr; data: xmlCharPtr); cdecl;
      ...
      resolveEntitySAXFunc = function  (ctx: Pointer; publicId: xmlCharPtr; systemId: xmlCharPtr) : xmlParserInputPtr; cdecl;
      ...
      startElementNsSAX2Func = procedure  (ctx: Pointer; localname: xmlCharPtr; prefix: xmlCharPtr; URI: xmlCharPtr; nb_namespaces: Longint; namespaces: xmlCharPtrPtr; nb_attributes: Longint; nb_defaulted: Longint; attributes: xmlCharPtrPtr); cdecl;
      ...
      unparsedEntityDeclSAXFunc = procedure  (ctx: Pointer; name: xmlCharPtr; publicId: xmlCharPtr; systemId: xmlCharPtr; notationName: xmlCharPtr); cdecl;
      ...
      xlinkExtendedLinkFunk = procedure  (ctx: Pointer; node: xmlNodePtr; nbLocators: Longint; hrefs: xlinkHRefPtr; roles: xlinkRolePtr; nbArcs: Longint; from: xlinkRolePtr; to_: xlinkRolePtr; show: xlinkShowPtr; actuate: xlinkActuatePtr; nbTitles: Longint; titles: xlinkTitlePtr; langs: xmlCharPtrPtr); cdecl;
        xlinkExtendedLinkFunkPtr = ^xlinkExtendedLinkFunk;

      xlinkExtendedLinkSetFunk = procedure  (ctx: Pointer; node: xmlNodePtr; nbLocators: Longint; hrefs: xlinkHRefPtr; roles: xlinkRolePtr; nbTitles: Longint; titles: xlinkTitlePtr; langs: xmlCharPtrPtr); cdecl;
      ...
      xmlCharEncodingInputFunc = function  (out_: PByte; outlen: PInteger; in_: PByte; inlen: PInteger) : Longint; cdecl;
        xmlCharEncodingInputFuncPtr = ^xmlCharEncodingInputFunc;

      xmlCharEncodingOutputFunc = function  (out_: PByte; outlen: PInteger; in_: PByte; inlen: PInteger) : Longint; cdecl;
      ...
      xmlExternalEntityLoader = function  (URL: PChar; ID: PChar; context: xmlParserCtxtPtr) : xmlParserInputPtr; cdecl;
      ...
      xmlHashScannerFull = procedure  (payload: Pointer; data: Pointer; name: xmlCharPtr; name2: xmlCharPtr; name3: xmlCharPtr); cdecl;
      ...
      xmlListDataCompare = function  (data0: Pointer; data1: Pointer) : Longint; cdecl;
      ...
      xmlListWalker = function  (data: Pointer; user: Pointer) : Longint; cdecl;
        xmlListWalkerPtr = ^xmlListWalker;

      xmlMallocFunc = function  (size: size_t) : Pointer; cdecl;
        xmlMallocFuncPtr = ^xmlMallocFunc;

      xmlOutputBufferCreateFilenameFunc = function  (URI: PChar; encoder: xmlCharEncodingHandlerPtr; compression: Longint) : xmlOutputBufferPtr; cdecl;
      ...
      xmlRegExecCallbacks = procedure  (exec: xmlRegExecCtxtPtr; token: xmlCharPtr; transdata: Pointer; inputdata: Pointer); cdecl;
      ...
      xmlXPathFuncLookupFunc = function  (ctxt: Pointer; name: xmlCharPtr; ns_uri: xmlCharPtr) : xmlXPathFunction; cdecl;
        xmlXPathFuncLookupFuncPtr = ^xmlXPathFuncLookupFunc;

      xmlXPathVariableLookupFunc = function  (ctxt: Pointer; name: xmlCharPtr; ns_uri: xmlCharPtr) : xmlXPathObjectPtr; cdecl;
...
*}
  ...
  function UTF8ToHtml (out_: PByte; outlen: PInteger; in_: PByte; inlen: PInteger) : Longint; cdecl; external LIBXML2_SO;
  function UTF8Toisolat1 (out_: PByte; outlen: PInteger; in_: PByte; inlen: PInteger) : Longint; cdecl; external LIBXML2_SO;
  procedure attribute (ctx: Pointer; fullname: xmlCharPtr; value: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure attributeDecl (ctx: Pointer; elem: xmlCharPtr; fullname: xmlCharPtr; type_: Longint; def: Longint; defaultValue: xmlCharPtr; tree: xmlEnumerationPtr); cdecl; external LIBXML2_SO;
  procedure cdataBlock (ctx: Pointer; value: xmlCharPtr; len: Longint); cdecl; external LIBXML2_SO;
  procedure characters (ctx: Pointer; ch: xmlCharPtr; len: Longint); cdecl; external LIBXML2_SO;
  function checkNamespace (ctx: Pointer; namespace: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  procedure comment (ctx: Pointer; value: xmlCharPtr); cdecl; external LIBXML2_SO;
  ...
  function docbEncodeEntities (out_: PByte; outlen: PInteger; in_: PByte; inlen: PInteger; quoteChar: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function docbParseDoc (cur: xmlCharPtr; encoding: PChar) : docbDocPtr; cdecl; external LIBXML2_SO;
  ...
  function docbSAXParseDoc (cur: xmlCharPtr; encoding: PChar; sax: docbSAXHandlerPtr; userData: Pointer) : docbDocPtr; cdecl; external LIBXML2_SO;
  ...
  procedure elementDecl (ctx: Pointer; name: xmlCharPtr; type_: Longint; content: xmlElementContentPtr); cdecl; external LIBXML2_SO;
  procedure endDocument (ctx: Pointer); cdecl; external LIBXML2_SO;
  procedure endElement (ctx: Pointer; name: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure entityDecl (ctx: Pointer; name: xmlCharPtr; type_: Longint; publicId: xmlCharPtr; systemId: xmlCharPtr; content: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure externalSubset (ctx: Pointer; name: xmlCharPtr; ExternalID: xmlCharPtr; SystemID: xmlCharPtr); cdecl; external LIBXML2_SO;
  function getColumnNumber (ctx: Pointer) : Longint; cdecl; external LIBXML2_SO;
  function getEntity (ctx: Pointer; name: xmlCharPtr) : xmlEntityPtr; cdecl; external LIBXML2_SO;
  ...
  function getParameterEntity (ctx: Pointer; name: xmlCharPtr) : xmlEntityPtr; cdecl; external LIBXML2_SO;
  ...
  procedure globalNamespace (ctx: Pointer; href: xmlCharPtr; prefix: xmlCharPtr); cdecl; external LIBXML2_SO;
  ...
  function htmlAttrAllowed (elt: htmlElemDescPtr; attr: xmlCharPtr; legacy: Longint) : htmlStatus; cdecl; external LIBXML2_SO;
  function htmlAutoCloseTag (doc: htmlDocPtr; name: xmlCharPtr; elem: htmlNodePtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  function htmlCtxtReadDoc (ctxt: htmlParserCtxtPtr; cur: xmlCharPtr; URL: PChar; encoding: PChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlCtxtReadFd (ctxt: htmlParserCtxtPtr; fd: Longint; URL: PChar; encoding: PChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlCtxtReadFile (ctxt: htmlParserCtxtPtr; filename: PChar; encoding: PChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlCtxtReadIO (ctxt: htmlParserCtxtPtr; ioread: xmlInputReadCallback; ioclose: xmlInputCloseCallback; ioctx: Pointer; URL: PChar; encoding: PChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlCtxtReadMemory (ctxt: htmlParserCtxtPtr; buffer: PChar; size: Longint; URL: PChar; encoding: PChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  ...
  function htmlElementAllowedHere (parent: htmlElemDescPtr; elt: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function htmlElementStatusHere (parent: htmlElemDescPtr; elt: htmlElemDescPtr) : htmlStatus; cdecl; external LIBXML2_SO;
  function htmlEncodeEntities (out_: PByte; outlen: PInteger; in_: PByte; inlen: PInteger; quoteChar: Longint) : Longint; cdecl; external LIBXML2_SO;
  function htmlEntityLookup (name: xmlCharPtr) : htmlEntityDescPtr; cdecl; external LIBXML2_SO;
  ...
  function htmlIsBooleanAttr (name: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function htmlIsScriptAttribute (name: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function htmlNewDoc (URI: xmlCharPtr; ExternalID: xmlCharPtr) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlNewDocNoDtD (URI: xmlCharPtr; ExternalID: xmlCharPtr) : htmlDocPtr; cdecl; external LIBXML2_SO;
  ...
  function htmlNodeDumpFileFormat (out_: PFILE; doc: xmlDocPtr; cur: xmlNodePtr; encoding: PChar; format: Longint) : Longint; cdecl; external LIBXML2_SO;
  procedure htmlNodeDumpFormatOutput (buf: xmlOutputBufferPtr; doc: xmlDocPtr; cur: xmlNodePtr; encoding: PChar; format: Longint); cdecl; external LIBXML2_SO;
  procedure htmlNodeDumpOutput (buf: xmlOutputBufferPtr; doc: xmlDocPtr; cur: xmlNodePtr; encoding: PChar); cdecl; external LIBXML2_SO;
  function htmlNodeStatus (node: htmlNodePtr; legacy: Longint) : htmlStatus; cdecl; external LIBXML2_SO;
  ...
  function htmlParseDoc (cur: xmlCharPtr; encoding: PChar) : htmlDocPtr; cdecl; external LIBXML2_SO;
  ...
  function htmlParseEntityRef (ctxt: htmlParserCtxtPtr; str: xmlCharPtrPtr) : htmlEntityDescPtr; cdecl; external LIBXML2_SO;
  function htmlParseFile (filename: PChar; encoding: PChar) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlReadDoc (cur: xmlCharPtr; URL: PChar; encoding: PChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlReadFd (fd: Longint; URL: PChar; encoding: PChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlReadFile (filename: PChar; encoding: PChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlReadIO (ioread: xmlInputReadCallback; ioclose: xmlInputCloseCallback; ioctx: Pointer; URL: PChar; encoding: PChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlReadMemory (buffer: PChar; size: Longint; URL: PChar; encoding: PChar; options: Longint) : htmlDocPtr; cdecl; external LIBXML2_SO;
  function htmlSAXParseDoc (cur: xmlCharPtr; encoding: PChar; sax: htmlSAXHandlerPtr; userData: Pointer) : htmlDocPtr; cdecl; external LIBXML2_SO;
  ...
  function htmlSetMetaEncoding (doc: htmlDocPtr; encoding: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function htmlTagLookup (tag: xmlCharPtr) : htmlElemDescPtr; cdecl; external LIBXML2_SO;
  procedure ignorableWhitespace (ctx: Pointer; ch: xmlCharPtr; len: Longint); cdecl; external LIBXML2_SO;
  ...
  procedure internalSubset (ctx: Pointer; name: xmlCharPtr; ExternalID: xmlCharPtr; SystemID: xmlCharPtr); cdecl; external LIBXML2_SO;
  function isStandalone (ctx: Pointer) : Longint; cdecl; external LIBXML2_SO;
  function isolat1ToUTF8 (out_: PByte; outlen: PInteger; in_: PByte; inlen: PInteger) : Longint; cdecl; external LIBXML2_SO;
  function namePop (ctxt: xmlParserCtxtPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function namePush (ctxt: xmlParserCtxtPtr; value: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  procedure namespaceDecl (ctx: Pointer; href: xmlCharPtr; prefix: xmlCharPtr); cdecl; external LIBXML2_SO;
  ...
  procedure notationDecl (ctx: Pointer; name: xmlCharPtr; publicId: xmlCharPtr; systemId: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure processingInstruction (ctx: Pointer; target: xmlCharPtr; data: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure reference (ctx: Pointer; name: xmlCharPtr); cdecl; external LIBXML2_SO;
  function resolveEntity (ctx: Pointer; publicId: xmlCharPtr; systemId: xmlCharPtr) : xmlParserInputPtr; cdecl; external LIBXML2_SO;
  procedure setDocumentLocator (ctx: Pointer; loc: xmlSAXLocatorPtr); cdecl; external LIBXML2_SO;
  procedure setNamespace (ctx: Pointer; name: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure startDocument (ctx: Pointer); cdecl; external LIBXML2_SO;
  procedure startElement (ctx: Pointer; fullname: xmlCharPtr; atts: xmlCharPtrPtr); cdecl; external LIBXML2_SO;
  procedure unparsedEntityDecl (ctx: Pointer; name: xmlCharPtr; publicId: xmlCharPtr; systemId: xmlCharPtr; notationName: xmlCharPtr); cdecl; external LIBXML2_SO;
  ...
  function xmlACatalogAdd (catal: xmlCatalogPtr; type_: xmlCharPtr; orig: xmlCharPtr; replace: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  procedure xmlACatalogDump (catal: xmlCatalogPtr; out_: PFILE); cdecl; external LIBXML2_SO;
  function xmlACatalogRemove (catal: xmlCatalogPtr; value: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlACatalogResolve (catal: xmlCatalogPtr; pubID: xmlCharPtr; sysID: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlACatalogResolvePublic (catal: xmlCatalogPtr; pubID: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlACatalogResolveSystem (catal: xmlCatalogPtr; sysID: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlACatalogResolveURI (catal: xmlCatalogPtr; URI: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlAddAttributeDecl (ctxt: xmlValidCtxtPtr; dtd: xmlDtdPtr; elem: xmlCharPtr; name: xmlCharPtr; ns: xmlCharPtr; type_: xmlAttributeType; def: xmlAttributeDefault; defaultValue: xmlCharPtr; tree: xmlEnumerationPtr) : xmlAttributePtr; cdecl; external LIBXML2_SO;
  ...
  function xmlAddDocEntity (doc: xmlDocPtr; name: xmlCharPtr; type_: Longint; ExternalID: xmlCharPtr; SystemID: xmlCharPtr; content: xmlCharPtr) : xmlEntityPtr; cdecl; external LIBXML2_SO;
  function xmlAddDtdEntity (doc: xmlDocPtr; name: xmlCharPtr; type_: Longint; ExternalID: xmlCharPtr; SystemID: xmlCharPtr; content: xmlCharPtr) : xmlEntityPtr; cdecl; external LIBXML2_SO;
  function xmlAddElementDecl (ctxt: xmlValidCtxtPtr; dtd: xmlDtdPtr; name: xmlCharPtr; type_: xmlElementTypeVal; content: xmlElementContentPtr) : xmlElementPtr; cdecl; external LIBXML2_SO;
  function xmlAddEncodingAlias (name: PChar; alias: PChar) : Longint; cdecl; external LIBXML2_SO;
  function xmlAddID (ctxt: xmlValidCtxtPtr; doc: xmlDocPtr; value: xmlCharPtr; attr: xmlAttrPtr) : xmlIDPtr; cdecl; external LIBXML2_SO;
  function xmlAddNextSibling (cur: xmlNodePtr; elem: xmlNodePtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlAddNotationDecl (ctxt: xmlValidCtxtPtr; dtd: xmlDtdPtr; name: xmlCharPtr; PublicID: xmlCharPtr; SystemID: xmlCharPtr) : xmlNotationPtr; cdecl; external LIBXML2_SO;
  function xmlAddPrevSibling (cur: xmlNodePtr; elem: xmlNodePtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlAddRef (ctxt: xmlValidCtxtPtr; doc: xmlDocPtr; value: xmlCharPtr; attr: xmlAttrPtr) : xmlRefPtr; cdecl; external LIBXML2_SO;
  ...
  procedure xmlAttrSerializeTxtContent (buf: xmlBufferPtr; doc: xmlDocPtr; attr: xmlAttrPtr; string_: xmlCharPtr); cdecl; external LIBXML2_SO;
  ...
  function xmlAutomataNewCountTrans (am: xmlAutomataPtr; from: xmlAutomataStatePtr; to_: xmlAutomataStatePtr; token: xmlCharPtr; min: Longint; max: Longint; data: Pointer) : xmlAutomataStatePtr; cdecl; external LIBXML2_SO;
  function xmlAutomataNewCountTrans2 (am: xmlAutomataPtr; from: xmlAutomataStatePtr; to_: xmlAutomataStatePtr; token: xmlCharPtr; token2: xmlCharPtr; min: Longint; max: Longint; data: Pointer) : xmlAutomataStatePtr; cdecl; external LIBXML2_SO;
  ...
  function xmlAutomataNewNegTrans (am: xmlAutomataPtr; from: xmlAutomataStatePtr; to_: xmlAutomataStatePtr; token: xmlCharPtr; token2: xmlCharPtr; data: Pointer) : xmlAutomataStatePtr; cdecl; external LIBXML2_SO;
  function xmlAutomataNewOnceTrans (am: xmlAutomataPtr; from: xmlAutomataStatePtr; to_: xmlAutomataStatePtr; token: xmlCharPtr; min: Longint; max: Longint; data: Pointer) : xmlAutomataStatePtr; cdecl; external LIBXML2_SO;
  function xmlAutomataNewOnceTrans2 (am: xmlAutomataPtr; from: xmlAutomataStatePtr; to_: xmlAutomataStatePtr; token: xmlCharPtr; token2: xmlCharPtr; min: Longint; max: Longint; data: Pointer) : xmlAutomataStatePtr; cdecl; external LIBXML2_SO;
  function xmlAutomataNewState (am: xmlAutomataPtr) : xmlAutomataStatePtr; cdecl; external LIBXML2_SO;
  function xmlAutomataNewTransition (am: xmlAutomataPtr; from: xmlAutomataStatePtr; to_: xmlAutomataStatePtr; token: xmlCharPtr; data: Pointer) : xmlAutomataStatePtr; cdecl; external LIBXML2_SO;
  function xmlAutomataNewTransition2 (am: xmlAutomataPtr; from: xmlAutomataStatePtr; to_: xmlAutomataStatePtr; token: xmlCharPtr; token2: xmlCharPtr; data: Pointer) : xmlAutomataStatePtr; cdecl; external LIBXML2_SO;
  ...
  function xmlBufferAdd (buf: xmlBufferPtr; str: xmlCharPtr; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlBufferAddHead (buf: xmlBufferPtr; str: xmlCharPtr; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlBufferCCat (buf: xmlBufferPtr; str: PChar) : Longint; cdecl; external LIBXML2_SO;
  function xmlBufferCat (buf: xmlBufferPtr; str: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlBufferContent (buf: xmlBufferPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  ...
  //// procedure xmlBufferWriteCHAR (buf: xmlBufferPtr; string_: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure xmlBufferWriteChar (buf: xmlBufferPtr; string_: PChar); cdecl; external LIBXML2_SO;
  procedure xmlBufferWriteQuotedString (buf: xmlBufferPtr; string_: xmlCharPtr); cdecl; external LIBXML2_SO;
  function xmlBuildQName (ncname: xmlCharPtr; prefix: xmlCharPtr; memory: xmlCharPtr; len: Longint) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlBuildRelativeURI (URI: xmlCharPtr; base: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlBuildURI (URI: xmlCharPtr; base: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlC14NDocSave (doc: xmlDocPtr; nodes: xmlNodeSetPtr; exclusive: Longint; inclusive_ns_prefixes: xmlCharPtrPtr; with_comments: Longint; filename: PChar; compression: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlCanonicPath (path: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlCatalogAdd (type_: xmlCharPtr; orig: xmlCharPtr; replace: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlCatalogAddLocal (catalogs: Pointer; URL: xmlCharPtr) : Pointer; cdecl; external LIBXML2_SO;
  ...
  function xmlCatalogGetPublic (pubID: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlCatalogGetSystem (sysID: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlCatalogIsEmpty (catal: xmlCatalogPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlCatalogLocalResolve (catalogs: Pointer; pubID: xmlCharPtr; sysID: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlCatalogLocalResolveURI (catalogs: Pointer; URI: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlCatalogRemove (value: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlCatalogResolve (pubID: xmlCharPtr; sysID: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlCatalogResolvePublic (pubID: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlCatalogResolveSystem (sysID: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlCatalogResolveURI (URI: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlCharInRange (val: Cardinal; rptr: xmlChRangeGroupPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlCharStrdup (cur: PChar) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlCharStrndup (cur: PChar; len: Longint) : xmlCharPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlCheckLanguageID (lang: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlCreateDocParserCtxt (cur: xmlCharPtr) : xmlParserCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlCreateEntitiesTable () : xmlEntitiesTablePtr; cdecl; external LIBXML2_SO;
  function xmlCreateEntityParserCtxt (URL: xmlCharPtr; ID: xmlCharPtr; base: xmlCharPtr) : xmlParserCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlCreateEnumeration (name: xmlCharPtr) : xmlEnumerationPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlCreateIntSubset (doc: xmlDocPtr; name: xmlCharPtr; ExternalID: xmlCharPtr; SystemID: xmlCharPtr) : xmlDtdPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlCreateURLParserCtxt (filename: PChar; options: Longint) : xmlParserCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlCtxtGetLastError (ctx: Pointer) : xmlErrorPtr; cdecl; external LIBXML2_SO;
  function xmlCtxtReadDoc (ctxt: xmlParserCtxtPtr; cur: xmlCharPtr; URL: PChar; encoding: PChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlCtxtReadFd (ctxt: xmlParserCtxtPtr; fd: Longint; URL: PChar; encoding: PChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlCtxtReadFile (ctxt: xmlParserCtxtPtr; filename: PChar; encoding: PChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlCtxtReadIO (ctxt: xmlParserCtxtPtr; ioread: xmlInputReadCallback; ioclose: xmlInputCloseCallback; ioctx: Pointer; URL: PChar; encoding: PChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlCtxtReadMemory (ctxt: xmlParserCtxtPtr; buffer: PChar; size: Longint; URL: PChar; encoding: PChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlCtxtResetPush (ctxt: xmlParserCtxtPtr; chunk: PChar; size: Longint; filename: PChar; encoding: PChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  procedure xmlDebugDumpString (output: PFILE; str: xmlCharPtr); cdecl; external LIBXML2_SO;
  ...
  function xmlDetectCharEncoding (in_: PByte; len: Longint) : xmlCharEncoding; cdecl; external LIBXML2_SO;
  ...
  function xmlDictExists (dict: xmlDictPtr; name: xmlCharPtr; len: Longint) : xmlCharPtr; cdecl; external LIBXML2_SO;
  procedure xmlDictFree (dict: xmlDictPtr); cdecl; external LIBXML2_SO;
  function xmlDictLookup (dict: xmlDictPtr; name: xmlCharPtr; len: Longint) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlDictOwns (dict: xmlDictPtr; str: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlDictQLookup (dict: xmlDictPtr; prefix: xmlCharPtr; name: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  ...
  procedure xmlDocDumpFormatMemoryEnc (out_doc: xmlDocPtr; doc_txt_ptr: xmlCharPtrPtr; doc_txt_len: PInteger; txt_encoding: PChar; format: Longint); cdecl; external LIBXML2_SO;
  procedure xmlDocDumpMemory (cur: xmlDocPtr; mem: xmlCharPtrPtr; size: PInteger); cdecl; external LIBXML2_SO;
  procedure xmlDocDumpMemoryEnc (out_doc: xmlDocPtr; doc_txt_ptr: xmlCharPtrPtr; doc_txt_len: PInteger; txt_encoding: PChar); cdecl; external LIBXML2_SO;
  ...
  function xmlEncodeEntities (doc: xmlDocPtr; input: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlEncodeEntitiesReentrant (doc: xmlDocPtr; input: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlEncodeSpecialChars (doc: xmlDocPtr; input: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  procedure xmlErrMemory (ctxt: xmlParserCtxtPtr; extra: PChar); cdecl; external LIBXML2_SO;
  ...
  function xmlExpGetLanguage (ctxt: xmlExpCtxtPtr; exp: xmlExpNodePtr; langList: xmlCharPtrPtr; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlExpGetStart (ctxt: xmlExpCtxtPtr; exp: xmlExpNodePtr; tokList: xmlCharPtrPtr; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlExpNewAtom (ctxt: xmlExpCtxtPtr; name: xmlCharPtr; len: Longint) : xmlExpNodePtr; cdecl; external LIBXML2_SO;
  ...
  function xmlExpParse (ctxt: xmlExpCtxtPtr; expr: PChar) : xmlExpNodePtr; cdecl; external LIBXML2_SO;
  procedure xmlExpRef (exp: xmlExpNodePtr); cdecl; external LIBXML2_SO;
  function xmlExpStringDerive (ctxt: xmlExpCtxtPtr; exp: xmlExpNodePtr; str: xmlCharPtr; len: Longint) : xmlExpNodePtr; cdecl; external LIBXML2_SO;
  ...
  function xmlGetDocEntity (doc: xmlDocPtr; name: xmlCharPtr) : xmlEntityPtr; cdecl; external LIBXML2_SO;
  function xmlGetDtdAttrDesc (dtd: xmlDtdPtr; elem: xmlCharPtr; name: xmlCharPtr) : xmlAttributePtr; cdecl; external LIBXML2_SO;
  function xmlGetDtdElementDesc (dtd: xmlDtdPtr; name: xmlCharPtr) : xmlElementPtr; cdecl; external LIBXML2_SO;
  function xmlGetDtdEntity (doc: xmlDocPtr; name: xmlCharPtr) : xmlEntityPtr; cdecl; external LIBXML2_SO;
  function xmlGetDtdNotationDesc (dtd: xmlDtdPtr; name: xmlCharPtr) : xmlNotationPtr; cdecl; external LIBXML2_SO;
  function xmlGetDtdQAttrDesc (dtd: xmlDtdPtr; elem: xmlCharPtr; name: xmlCharPtr; prefix: xmlCharPtr) : xmlAttributePtr; cdecl; external LIBXML2_SO;
  function xmlGetDtdQElementDesc (dtd: xmlDtdPtr; name: xmlCharPtr; prefix: xmlCharPtr) : xmlElementPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlGetFeaturesList (len: PInteger; result: PPChar) : Longint; cdecl; external LIBXML2_SO;
  function xmlGetGlobalState () : xmlGlobalStatePtr; cdecl; external LIBXML2_SO;
  function xmlGetID (doc: xmlDocPtr; ID: xmlCharPtr) : xmlAttrPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlGetNoNsProp (node: xmlNodePtr; name: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlGetNsProp (node: xmlNodePtr; name: xmlCharPtr; nameSpace: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlGetParameterEntity (doc: xmlDocPtr; name: xmlCharPtr) : xmlEntityPtr; cdecl; external LIBXML2_SO;
  function xmlGetPredefinedEntity (name: xmlCharPtr) : xmlEntityPtr; cdecl; external LIBXML2_SO;
  function xmlGetProp (node: xmlNodePtr; name: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlGetRefs (doc: xmlDocPtr; ID: xmlCharPtr) : xmlListPtr; cdecl; external LIBXML2_SO;
  function xmlGetThreadId () : Longint; cdecl; external LIBXML2_SO;
  function xmlGetUTF8Char (utf: PByte; len: PInteger) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlHasNsProp (node: xmlNodePtr; name: xmlCharPtr; nameSpace: xmlCharPtr) : xmlAttrPtr; cdecl; external LIBXML2_SO;
  function xmlHasProp (node: xmlNodePtr; name: xmlCharPtr) : xmlAttrPtr; cdecl; external LIBXML2_SO;
  function xmlHashAddEntry (table: xmlHashTablePtr; name: xmlCharPtr; userdata: Pointer) : Longint; cdecl; external LIBXML2_SO;
  function xmlHashAddEntry2 (table: xmlHashTablePtr; name: xmlCharPtr; name2: xmlCharPtr; userdata: Pointer) : Longint; cdecl; external LIBXML2_SO;
  function xmlHashAddEntry3 (table: xmlHashTablePtr; name: xmlCharPtr; name2: xmlCharPtr; name3: xmlCharPtr; userdata: Pointer) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlHashLookup (table: xmlHashTablePtr; name: xmlCharPtr) : Pointer; cdecl; external LIBXML2_SO;
  function xmlHashLookup2 (table: xmlHashTablePtr; name: xmlCharPtr; name2: xmlCharPtr) : Pointer; cdecl; external LIBXML2_SO;
  function xmlHashLookup3 (table: xmlHashTablePtr; name: xmlCharPtr; name2: xmlCharPtr; name3: xmlCharPtr) : Pointer; cdecl; external LIBXML2_SO;
  function xmlHashQLookup (table: xmlHashTablePtr; prefix: xmlCharPtr; name: xmlCharPtr) : Pointer; cdecl; external LIBXML2_SO;
  function xmlHashQLookup2 (table: xmlHashTablePtr; prefix: xmlCharPtr; name: xmlCharPtr; prefix2: xmlCharPtr; name2: xmlCharPtr) : Pointer; cdecl; external LIBXML2_SO;
  function xmlHashQLookup3 (table: xmlHashTablePtr; prefix: xmlCharPtr; name: xmlCharPtr; prefix2: xmlCharPtr; name2: xmlCharPtr; prefix3: xmlCharPtr; name3: xmlCharPtr) : Pointer; cdecl; external LIBXML2_SO;
  function xmlHashRemoveEntry (table: xmlHashTablePtr; name: xmlCharPtr; f: xmlHashDeallocator) : Longint; cdecl; external LIBXML2_SO;
  function xmlHashRemoveEntry2 (table: xmlHashTablePtr; name: xmlCharPtr; name2: xmlCharPtr; f: xmlHashDeallocator) : Longint; cdecl; external LIBXML2_SO;
  function xmlHashRemoveEntry3 (table: xmlHashTablePtr; name: xmlCharPtr; name2: xmlCharPtr; name3: xmlCharPtr; f: xmlHashDeallocator) : Longint; cdecl; external LIBXML2_SO;
  procedure xmlHashScan (table: xmlHashTablePtr; f: xmlHashScanner; data: Pointer); cdecl; external LIBXML2_SO;
  procedure xmlHashScan3 (table: xmlHashTablePtr; name: xmlCharPtr; name2: xmlCharPtr; name3: xmlCharPtr; f: xmlHashScanner; data: Pointer); cdecl; external LIBXML2_SO;
  procedure xmlHashScanFull (table: xmlHashTablePtr; f: xmlHashScannerFull; data: Pointer); cdecl; external LIBXML2_SO;
  procedure xmlHashScanFull3 (table: xmlHashTablePtr; name: xmlCharPtr; name2: xmlCharPtr; name3: xmlCharPtr; f: xmlHashScannerFull; data: Pointer); cdecl; external LIBXML2_SO;
  function xmlHashSize (table: xmlHashTablePtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlHashUpdateEntry (table: xmlHashTablePtr; name: xmlCharPtr; userdata: Pointer; f: xmlHashDeallocator) : Longint; cdecl; external LIBXML2_SO;
  function xmlHashUpdateEntry2 (table: xmlHashTablePtr; name: xmlCharPtr; name2: xmlCharPtr; userdata: Pointer; f: xmlHashDeallocator) : Longint; cdecl; external LIBXML2_SO;
  function xmlHashUpdateEntry3 (table: xmlHashTablePtr; name: xmlCharPtr; name2: xmlCharPtr; name3: xmlCharPtr; userdata: Pointer; f: xmlHashDeallocator) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlIsMixedElement (doc: xmlDocPtr; name: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlIsXHTML (systemID: xmlCharPtr; publicID: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  procedure xmlLoadCatalogs (pathss: PChar); cdecl; external LIBXML2_SO;
  function xmlLoadExternalEntity (URL: PChar; ID: PChar; ctxt: xmlParserCtxtPtr) : xmlParserInputPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlMallocAtomicLoc (size: size_t; file_: PChar; line: Longint) : Pointer; cdecl; external LIBXML2_SO;
  function xmlMallocLoc (size: size_t; file_: PChar; line: Longint) : Pointer; cdecl; external LIBXML2_SO;
  ...
  function xmlMemStrdupLoc (str: PChar; file_: PChar; line: Longint) : PChar; cdecl; external LIBXML2_SO;
  ...
  function xmlModuleOpen (name: PChar; options: Longint) : xmlModulePtr; cdecl; external LIBXML2_SO;
  function xmlModuleSymbol (module: xmlModulePtr; name: PChar; symbol: PPointer) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlNanoFTPDele (ctx: Pointer; file_: PChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlNewCDataBlock (doc: xmlDocPtr; content: xmlCharPtr; len: Longint) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewCatalog (sgml: Longint) : xmlCatalogPtr; cdecl; external LIBXML2_SO;
  function xmlNewCharEncodingHandler (name: PChar; input: xmlCharEncodingInputFunc; output: xmlCharEncodingOutputFunc) : xmlCharEncodingHandlerPtr; cdecl; external LIBXML2_SO;
  function xmlNewCharRef (doc: xmlDocPtr; name: xmlCharPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewChild (parent: xmlNodePtr; ns: xmlNsPtr; name: xmlCharPtr; content: xmlCharPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewComment (content: xmlCharPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewDoc (version: xmlCharPtr) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlNewDocComment (doc: xmlDocPtr; content: xmlCharPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewDocElementContent (doc: xmlDocPtr; name: xmlCharPtr; type_: xmlElementContentType) : xmlElementContentPtr; cdecl; external LIBXML2_SO;
  function xmlNewDocFragment (doc: xmlDocPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewDocNode (doc: xmlDocPtr; ns: xmlNsPtr; name: xmlCharPtr; content: xmlCharPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewDocNodeEatName (doc: xmlDocPtr; ns: xmlNsPtr; name: xmlCharPtr; content: xmlCharPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewDocPI (doc: xmlDocPtr; name: xmlCharPtr; content: xmlCharPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewDocProp (doc: xmlDocPtr; name: xmlCharPtr; value: xmlCharPtr) : xmlAttrPtr; cdecl; external LIBXML2_SO;
  function xmlNewDocRawNode (doc: xmlDocPtr; ns: xmlNsPtr; name: xmlCharPtr; content: xmlCharPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewDocText (doc: xmlDocPtr; content: xmlCharPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewDocTextLen (doc: xmlDocPtr; content: xmlCharPtr; len: Longint) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewDtd (doc: xmlDocPtr; name: xmlCharPtr; ExternalID: xmlCharPtr; SystemID: xmlCharPtr) : xmlDtdPtr; cdecl; external LIBXML2_SO;
  function xmlNewElementContent (name: xmlCharPtr; type_: xmlElementContentType) : xmlElementContentPtr; cdecl; external LIBXML2_SO;
  function xmlNewEntityInputStream (ctxt: xmlParserCtxtPtr; entity: xmlEntityPtr) : xmlParserInputPtr; cdecl; external LIBXML2_SO;
  function xmlNewGlobalNs (doc: xmlDocPtr; href: xmlCharPtr; prefix: xmlCharPtr) : xmlNsPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlNewNode (ns: xmlNsPtr; name: xmlCharPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewNodeEatName (ns: xmlNsPtr; name: xmlCharPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewNs (node: xmlNodePtr; href: xmlCharPtr; prefix: xmlCharPtr) : xmlNsPtr; cdecl; external LIBXML2_SO;
  function xmlNewNsProp (node: xmlNodePtr; ns: xmlNsPtr; name: xmlCharPtr; value: xmlCharPtr) : xmlAttrPtr; cdecl; external LIBXML2_SO;
  function xmlNewNsPropEatName (node: xmlNodePtr; ns: xmlNsPtr; name: xmlCharPtr; value: xmlCharPtr) : xmlAttrPtr; cdecl; external LIBXML2_SO;
  function xmlNewPI (name: xmlCharPtr; content: xmlCharPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewParserCtxt () : xmlParserCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlNewProp (node: xmlNodePtr; name: xmlCharPtr; value: xmlCharPtr) : xmlAttrPtr; cdecl; external LIBXML2_SO;
  function xmlNewRMutex () : xmlRMutexPtr; cdecl; external LIBXML2_SO;
  function xmlNewReference (doc: xmlDocPtr; name: xmlCharPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewStringInputStream (ctxt: xmlParserCtxtPtr; buffer: xmlCharPtr) : xmlParserInputPtr; cdecl; external LIBXML2_SO;
  function xmlNewText (content: xmlCharPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewTextChild (parent: xmlNodePtr; ns: xmlNsPtr; name: xmlCharPtr; content: xmlCharPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlNewTextLen (content: xmlCharPtr; len: Longint) : xmlNodePtr; cdecl; external LIBXML2_SO;
  ...
  function xmlNewTextWriterFilename (uri: PChar; compression: Longint) : xmlTextWriterPtr; cdecl; external LIBXML2_SO;
  ...
  procedure xmlNodeAddContent (cur: xmlNodePtr; content: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure xmlNodeAddContentLen (cur: xmlNodePtr; content: xmlCharPtr; len: Longint); cdecl; external LIBXML2_SO;
  ...
  procedure xmlNodeSetBase (cur: xmlNodePtr; uri: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure xmlNodeSetContent (cur: xmlNodePtr; content: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure xmlNodeSetContentLen (cur: xmlNodePtr; content: xmlCharPtr; len: Longint); cdecl; external LIBXML2_SO;
  procedure xmlNodeSetLang (cur: xmlNodePtr; lang: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure xmlNodeSetName (cur: xmlNodePtr; name: xmlCharPtr); cdecl; external LIBXML2_SO;
  ...
  function xmlNormalizeWindowsPath (path: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlOutputBufferWrite (out_: xmlOutputBufferPtr; len: Longint; buf: PChar) : Longint; cdecl; external LIBXML2_SO;
  function xmlOutputBufferWriteEscape (out_: xmlOutputBufferPtr; str: xmlCharPtr; escaping: xmlCharEncodingOutputFunc) : Longint; cdecl; external LIBXML2_SO;
  function xmlOutputBufferWriteString (out_: xmlOutputBufferPtr; str: PChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlParseBalancedChunkMemory (doc: xmlDocPtr; sax: xmlSAXHandlerPtr; user_data: Pointer; depth: Longint; string_: xmlCharPtr; lst: xmlNodePtrPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlParseBalancedChunkMemoryRecover (doc: xmlDocPtr; sax: xmlSAXHandlerPtr; user_data: Pointer; depth: Longint; string_: xmlCharPtr; lst: xmlNodePtrPtr; recover: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlParseCtxtExternalEntity (ctx: xmlParserCtxtPtr; URL: xmlCharPtr; ID: xmlCharPtr; lst: xmlNodePtrPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlParseDTD (ExternalID: xmlCharPtr; SystemID: xmlCharPtr) : xmlDtdPtr; cdecl; external LIBXML2_SO;
  function xmlParseDefaultDecl (ctxt: xmlParserCtxtPtr; value: xmlCharPtrPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlParseDoc (cur: xmlCharPtr) : xmlDocPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlParseElementContentDecl (ctxt: xmlParserCtxtPtr; name: xmlCharPtr; result: xmlElementContentPtrPtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlParseExternalEntity (doc: xmlDocPtr; sax: xmlSAXHandlerPtr; user_data: Pointer; depth: Longint; URL: xmlCharPtr; ID: xmlCharPtr; lst: xmlNodePtrPtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  procedure xmlParseExternalSubset (ctxt: xmlParserCtxtPtr; ExternalID: xmlCharPtr; SystemID: xmlCharPtr); cdecl; external LIBXML2_SO;
  function xmlParseFile (filename: PChar) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlParseInNodeContext (node: xmlNodePtr; data: PChar; datalen: Longint; options: Longint; lst: xmlNodePtrPtr) : xmlParserErrors; cdecl; external LIBXML2_SO;
  ...
  function xmlParseURIRaw (str: PChar; raw: Longint) : xmlURIPtr; cdecl; external LIBXML2_SO;
  ...
  procedure xmlParserError (ctx: Pointer; msg: PChar); cdecl; varargs; external LIBXML2_SO;
  function xmlParserFindNodeInfo (ctx: xmlParserCtxtPtr; node: xmlNodePtr) : xmlParserNodeInfoPtr; cdecl; external LIBXML2_SO;
  function xmlParserFindNodeInfoIndex (seq: xmlParserNodeInfoSeqPtr; node: xmlNodePtr) : Cardinal; cdecl; external LIBXML2_SO;
  ...
  function xmlParserInputBufferPush (in_: xmlParserInputBufferPtr; len: Longint; buf: PChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  procedure xmlParserValidityError (ctx: Pointer; msg: PChar); cdecl; varargs; external LIBXML2_SO;
  procedure xmlParserValidityWarning (ctx: Pointer; msg: PChar); cdecl; varargs; external LIBXML2_SO;
  procedure xmlParserWarning (ctx: Pointer; msg: PChar); cdecl; varargs; external LIBXML2_SO;
  ...
  function xmlPatterncompile (pattern: xmlCharPtr; dict: xmlDictPtr; flags: Longint; namespaces: xmlCharPtrPtr) : xmlPatternPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlReadDoc (cur: xmlCharPtr; URL: PChar; encoding: PChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlReadFd (fd: Longint; URL: PChar; encoding: PChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlReadFile (filename: PChar; encoding: PChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlReadIO (ioread: xmlInputReadCallback; ioclose: xmlInputCloseCallback; ioctx: Pointer; URL: PChar; encoding: PChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlReadMemory (buffer: PChar; size: Longint; URL: PChar; encoding: PChar; options: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  function xmlReaderForDoc (cur: xmlCharPtr; URL: PChar; encoding: PChar; options: Longint) : xmlTextReaderPtr; cdecl; external LIBXML2_SO;
  function xmlReaderForFd (fd: Longint; URL: PChar; encoding: PChar; options: Longint) : xmlTextReaderPtr; cdecl; external LIBXML2_SO;
  function xmlReaderForFile (filename: PChar; encoding: PChar; options: Longint) : xmlTextReaderPtr; cdecl; external LIBXML2_SO;
  function xmlReaderForIO (ioread: xmlInputReadCallback; ioclose: xmlInputCloseCallback; ioctx: Pointer; URL: PChar; encoding: PChar; options: Longint) : xmlTextReaderPtr; cdecl; external LIBXML2_SO;
  function xmlReaderForMemory (buffer: PChar; size: Longint; URL: PChar; encoding: PChar; options: Longint) : xmlTextReaderPtr; cdecl; external LIBXML2_SO;
  function xmlReaderNewDoc (reader: xmlTextReaderPtr; cur: xmlCharPtr; URL: PChar; encoding: PChar; options: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlReaderNewFd (reader: xmlTextReaderPtr; fd: Longint; URL: PChar; encoding: PChar; options: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlReaderNewFile (reader: xmlTextReaderPtr; filename: PChar; encoding: PChar; options: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlReaderNewIO (reader: xmlTextReaderPtr; ioread: xmlInputReadCallback; ioclose: xmlInputCloseCallback; ioctx: Pointer; URL: PChar; encoding: PChar; options: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlReaderNewMemory (reader: xmlTextReaderPtr; buffer: PChar; size: Longint; URL: PChar; encoding: PChar; options: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlReallocLoc (ptr: Pointer; size: size_t; file_: PChar; line: Longint) : Pointer; cdecl; external LIBXML2_SO;
  ...
  function xmlRegExecErrInfo (exec: xmlRegExecCtxtPtr; string_: xmlCharPtrPtr; nbval: PInteger; nbneg: PInteger; values: xmlCharPtrPtr; terminal: PInteger) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlRegExecPushString (exec: xmlRegExecCtxtPtr; value: xmlCharPtr; data: Pointer) : Longint; cdecl; external LIBXML2_SO;
  function xmlRegExecPushString2 (exec: xmlRegExecCtxtPtr; value: xmlCharPtr; value2: xmlCharPtr; data: Pointer) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlRegexpCompile (regexp: xmlCharPtr) : xmlRegexpPtr; cdecl; external LIBXML2_SO;
  function xmlRegexpExec (comp: xmlRegexpPtr; content: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlRelaxNGValidatePushCData (ctxt: xmlRelaxNGValidCtxtPtr; data: xmlCharPtr; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  procedure xmlSAX2AttributeDecl (ctx: Pointer; elem: xmlCharPtr; fullname: xmlCharPtr; type_: Longint; def: Longint; defaultValue: xmlCharPtr; tree: xmlEnumerationPtr); cdecl; external LIBXML2_SO;
  procedure xmlSAX2CDataBlock (ctx: Pointer; value: xmlCharPtr; len: Longint); cdecl; external LIBXML2_SO;
  procedure xmlSAX2Characters (ctx: Pointer; ch: xmlCharPtr; len: Longint); cdecl; external LIBXML2_SO;
  procedure xmlSAX2Comment (ctx: Pointer; value: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure xmlSAX2ElementDecl (ctx: Pointer; name: xmlCharPtr; type_: Longint; content: xmlElementContentPtr); cdecl; external LIBXML2_SO;
  procedure xmlSAX2EndDocument (ctx: Pointer); cdecl; external LIBXML2_SO;
  procedure xmlSAX2EndElement (ctx: Pointer; name: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure xmlSAX2EndElementNs (ctx: Pointer; localname: xmlCharPtr; prefix: xmlCharPtr; URI: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure xmlSAX2EntityDecl (ctx: Pointer; name: xmlCharPtr; type_: Longint; publicId: xmlCharPtr; systemId: xmlCharPtr; content: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure xmlSAX2ExternalSubset (ctx: Pointer; name: xmlCharPtr; ExternalID: xmlCharPtr; SystemID: xmlCharPtr); cdecl; external LIBXML2_SO;
  function xmlSAX2GetColumnNumber (ctx: Pointer) : Longint; cdecl; external LIBXML2_SO;
  function xmlSAX2GetEntity (ctx: Pointer; name: xmlCharPtr) : xmlEntityPtr; cdecl; external LIBXML2_SO;
  function xmlSAX2GetLineNumber (ctx: Pointer) : Longint; cdecl; external LIBXML2_SO;
  function xmlSAX2GetParameterEntity (ctx: Pointer; name: xmlCharPtr) : xmlEntityPtr; cdecl; external LIBXML2_SO;
  ...
  procedure xmlSAX2IgnorableWhitespace (ctx: Pointer; ch: xmlCharPtr; len: Longint); cdecl; external LIBXML2_SO;
  ...
  procedure xmlSAX2InternalSubset (ctx: Pointer; name: xmlCharPtr; ExternalID: xmlCharPtr; SystemID: xmlCharPtr); cdecl; external LIBXML2_SO;
  function xmlSAX2IsStandalone (ctx: Pointer) : Longint; cdecl; external LIBXML2_SO;
  procedure xmlSAX2NotationDecl (ctx: Pointer; name: xmlCharPtr; publicId: xmlCharPtr; systemId: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure xmlSAX2ProcessingInstruction (ctx: Pointer; target: xmlCharPtr; data: xmlCharPtr); cdecl; external LIBXML2_SO;
  procedure xmlSAX2Reference (ctx: Pointer; name: xmlCharPtr); cdecl; external LIBXML2_SO;
  function xmlSAX2ResolveEntity (ctx: Pointer; publicId: xmlCharPtr; systemId: xmlCharPtr) : xmlParserInputPtr; cdecl; external LIBXML2_SO;
  ...
  procedure xmlSAX2StartElement (ctx: Pointer; fullname: xmlCharPtr; atts: xmlCharPtrPtr); cdecl; external LIBXML2_SO;
  procedure xmlSAX2StartElementNs (ctx: Pointer; localname: xmlCharPtr; prefix: xmlCharPtr; URI: xmlCharPtr; nb_namespaces: Longint; namespaces: xmlCharPtrPtr; nb_attributes: Longint; nb_defaulted: Longint; attributes: xmlCharPtrPtr); cdecl; external LIBXML2_SO;
  procedure xmlSAX2UnparsedEntityDecl (ctx: Pointer; name: xmlCharPtr; publicId: xmlCharPtr; systemId: xmlCharPtr; notationName: xmlCharPtr); cdecl; external LIBXML2_SO;
  function xmlSAXDefaultVersion (version: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlSAXParseDTD (sax: xmlSAXHandlerPtr; ExternalID: xmlCharPtr; SystemID: xmlCharPtr) : xmlDtdPtr; cdecl; external LIBXML2_SO;
  function xmlSAXParseDoc (sax: xmlSAXHandlerPtr; cur: xmlCharPtr; recovery: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlSaveFormatFileEnc (filename: PChar; cur: xmlDocPtr; encoding: PChar; format: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlSaveToBuffer (buffer: xmlBufferPtr; encoding: PChar; options: Longint) : xmlSaveCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlSaveToFd (fd: Longint; encoding: PChar; options: Longint) : xmlSaveCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlSaveToFilename (filename: PChar; encoding: PChar; options: Longint) : xmlSaveCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlSaveToIO (iowrite: xmlOutputWriteCallback; ioclose: xmlOutputCloseCallback; ioctx: Pointer; encoding: PChar; options: Longint) : xmlSaveCtxtPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlSchemaCheckFacet (facet: xmlSchemaFacetPtr; typeDecl: xmlSchemaTypePtr; pctxt: xmlSchemaParserCtxtPtr; name: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  procedure xmlSchemaCleanupTypes (); cdecl; external LIBXML2_SO;
  function xmlSchemaCollapseString (value: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlSchemaGetCanonValue (val: xmlSchemaValPtr; retValue: xmlCharPtrPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlSchemaGetCanonValueWhtsp (val: xmlSchemaValPtr; retValue: xmlCharPtrPtr; ws: xmlSchemaWhitespaceValueType) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlSchemaGetPredefinedType (name: xmlCharPtr; ns: xmlCharPtr) : xmlSchemaTypePtr; cdecl; external LIBXML2_SO;
  ...
  function xmlSchemaNewNOTATIONValue (name: xmlCharPtr; ns: xmlCharPtr) : xmlSchemaValPtr; cdecl; external LIBXML2_SO;
  function xmlSchemaNewParserCtxt (URL: PChar) : xmlSchemaParserCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlSchemaNewQNameValue (namespaceName: xmlCharPtr; localName: xmlCharPtr) : xmlSchemaValPtr; cdecl; external LIBXML2_SO;
  function xmlSchemaNewStringValue (type_: xmlSchemaValType; value: xmlCharPtr) : xmlSchemaValPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlSchemaValPredefTypeNode (type_: xmlSchemaTypePtr; value: xmlCharPtr; val: xmlSchemaValPtrPtr; node: xmlNodePtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlSchemaValPredefTypeNodeNoNorm (type_: xmlSchemaTypePtr; value: xmlCharPtr; val: xmlSchemaValPtrPtr; node: xmlNodePtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlSchemaValidateFacet (base: xmlSchemaTypePtr; facet: xmlSchemaFacetPtr; value: xmlCharPtr; val: xmlSchemaValPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlSchemaValidateFacetWhtsp (facet: xmlSchemaFacetPtr; fws: xmlSchemaWhitespaceValueType; valType: xmlSchemaValType; value: xmlCharPtr; val: xmlSchemaValPtr; ws: xmlSchemaWhitespaceValueType) : Longint; cdecl; external LIBXML2_SO;
  function xmlSchemaValidateFile (ctxt: xmlSchemaValidCtxtPtr; filename: PChar; options: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlSchemaValidateLengthFacet (type_: xmlSchemaTypePtr; facet: xmlSchemaFacetPtr; value: xmlCharPtr; val: xmlSchemaValPtr; length: PCardinal) : Longint; cdecl; external LIBXML2_SO;
  function xmlSchemaValidateLengthFacetWhtsp (facet: xmlSchemaFacetPtr; valType: xmlSchemaValType; value: xmlCharPtr; val: xmlSchemaValPtr; length: PCardinal; ws: xmlSchemaWhitespaceValueType) : Longint; cdecl; external LIBXML2_SO;
  function xmlSchemaValidateListSimpleTypeFacet (facet: xmlSchemaFacetPtr; value: xmlCharPtr; actualLen: Cardinal; expectedLen: PCardinal) : Longint; cdecl; external LIBXML2_SO;
  function xmlSchemaValidateOneElement (ctxt: xmlSchemaValidCtxtPtr; elem: xmlNodePtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlSchemaValidatePredefinedType (type_: xmlSchemaTypePtr; value: xmlCharPtr; val: xmlSchemaValPtrPtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlSchemaWhiteSpaceReplace (value: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlSchematronNewMemParserCtxt (buffer: PChar; size: Longint) : xmlSchematronParserCtxtPtr; cdecl; external LIBXML2_SO;
  function xmlSchematronNewParserCtxt (URL: PChar) : xmlSchematronParserCtxtPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlSearchNs (doc: xmlDocPtr; node: xmlNodePtr; nameSpace: xmlCharPtr) : xmlNsPtr; cdecl; external LIBXML2_SO;
  function xmlSearchNsByHref (doc: xmlDocPtr; node: xmlNodePtr; href: xmlCharPtr) : xmlNsPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlSetNsProp (node: xmlNodePtr; ns: xmlNsPtr; name: xmlCharPtr; value: xmlCharPtr) : xmlAttrPtr; cdecl; external LIBXML2_SO;
  function xmlSetProp (node: xmlNodePtr; name: xmlCharPtr; value: xmlCharPtr) : xmlAttrPtr; cdecl; external LIBXML2_SO;
  ...
  procedure xmlSetupParserForBuffer (ctxt: xmlParserCtxtPtr; buffer: xmlCharPtr; filename: PChar); cdecl; external LIBXML2_SO;
  ...
  function xmlSplitQName (ctxt: xmlParserCtxtPtr; name: xmlCharPtr; prefix: xmlCharPtrPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlSplitQName2 (name: xmlCharPtr; prefix: xmlCharPtrPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlSplitQName3 (name: xmlCharPtr; len: PInteger) : xmlCharPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlStrEqual (str1: xmlCharPtr; str2: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlStrPrintf (buf: xmlCharPtr; len: Longint; msg: xmlCharPtr) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlStrQEqual (pref: xmlCharPtr; name: xmlCharPtr; str: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlStrVPrintf (buf: xmlCharPtr; len: Longint; msg: xmlCharPtr; ap: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlStrcasecmp (str1: xmlCharPtr; str2: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlStrcasestr (str: xmlCharPtr; val: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlStrcat (cur: xmlCharPtr; add: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlStrchr (str: xmlCharPtr; val: xmlChar) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlStrcmp (str1: xmlCharPtr; str2: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlStrdup (cur: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlStreamPop (stream: xmlStreamCtxtPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlStreamPush (stream: xmlStreamCtxtPtr; name: xmlCharPtr; ns: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlStreamPushAttr (stream: xmlStreamCtxtPtr; name: xmlCharPtr; ns: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlStreamPushNode (stream: xmlStreamCtxtPtr; name: xmlCharPtr; ns: xmlCharPtr; nodeType: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlStreamWantsAnyNode (streamCtxt: xmlStreamCtxtPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlStringCurrentChar (ctxt: xmlParserCtxtPtr; cur: xmlCharPtr; len: PInteger) : Longint; cdecl; external LIBXML2_SO;
  function xmlStringDecodeEntities (ctxt: xmlParserCtxtPtr; str: xmlCharPtr; what: Longint; end_: xmlChar; end2: xmlChar; end3: xmlChar) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlStringGetNodeList (doc: xmlDocPtr; value: xmlCharPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlStringLenDecodeEntities (ctxt: xmlParserCtxtPtr; str: xmlCharPtr; len: Longint; what: Longint; end_: xmlChar; end2: xmlChar; end3: xmlChar) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlStringLenGetNodeList (doc: xmlDocPtr; value: xmlCharPtr; len: Longint) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlStrlen (str: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlStrncasecmp (str1: xmlCharPtr; str2: xmlCharPtr; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlStrncat (cur: xmlCharPtr; add: xmlCharPtr; len: Longint) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlStrncatNew (str1: xmlCharPtr; str2: xmlCharPtr; len: Longint) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlStrncmp (str1: xmlCharPtr; str2: xmlCharPtr; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlStrndup (cur: xmlCharPtr; len: Longint) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlStrstr (str: xmlCharPtr; val: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlStrsub (str: xmlCharPtr; start: Longint; len: Longint) : xmlCharPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlTextConcat (node: xmlNodePtr; content: xmlCharPtr; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlTextReaderConstString (reader: xmlTextReaderPtr; str: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlTextReaderGetAttribute (reader: xmlTextReaderPtr; name: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlTextReaderGetAttributeNo (reader: xmlTextReaderPtr; no: Longint) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlTextReaderGetAttributeNs (reader: xmlTextReaderPtr; localName: xmlCharPtr; namespaceURI: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlTextReaderLookupNamespace (reader: xmlTextReaderPtr; prefix: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlTextReaderMoveToAttribute (reader: xmlTextReaderPtr; name: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextReaderMoveToAttributeNo (reader: xmlTextReaderPtr; no: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextReaderMoveToAttributeNs (reader: xmlTextReaderPtr; localName: xmlCharPtr; namespaceURI: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlTextReaderPreservePattern (reader: xmlTextReaderPtr; pattern: xmlCharPtr; namespaces: xmlCharPtrPtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlTextReaderSchemaValidate (reader: xmlTextReaderPtr; xsd: PChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlTextWriterSetIndentString (writer: xmlTextWriterPtr; str: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterStartAttribute (writer: xmlTextWriterPtr; name: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterStartAttributeNS (writer: xmlTextWriterPtr; prefix: xmlCharPtr; name: xmlCharPtr; namespaceURI: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlTextWriterStartDTD (writer: xmlTextWriterPtr; name: xmlCharPtr; pubid: xmlCharPtr; sysid: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterStartDTDAttlist (writer: xmlTextWriterPtr; name: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterStartDTDElement (writer: xmlTextWriterPtr; name: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterStartDTDEntity (writer: xmlTextWriterPtr; pe: Longint; name: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterStartDocument (writer: xmlTextWriterPtr; version: PChar; encoding: PChar; standalone: PChar) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterStartElement (writer: xmlTextWriterPtr; name: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterStartElementNS (writer: xmlTextWriterPtr; prefix: xmlCharPtr; name: xmlCharPtr; namespaceURI: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterStartPI (writer: xmlTextWriterPtr; target: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteAttribute (writer: xmlTextWriterPtr; name: xmlCharPtr; content: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteAttributeNS (writer: xmlTextWriterPtr; prefix: xmlCharPtr; name: xmlCharPtr; namespaceURI: xmlCharPtr; content: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteBase64 (writer: xmlTextWriterPtr; data: PChar; start: Longint; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteBinHex (writer: xmlTextWriterPtr; data: PChar; start: Longint; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteCDATA (writer: xmlTextWriterPtr; content: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteComment (writer: xmlTextWriterPtr; content: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteDTD (writer: xmlTextWriterPtr; name: xmlCharPtr; pubid: xmlCharPtr; sysid: xmlCharPtr; subset: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteDTDAttlist (writer: xmlTextWriterPtr; name: xmlCharPtr; content: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteDTDElement (writer: xmlTextWriterPtr; name: xmlCharPtr; content: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteDTDEntity (writer: xmlTextWriterPtr; pe: Longint; name: xmlCharPtr; pubid: xmlCharPtr; sysid: xmlCharPtr; ndataid: xmlCharPtr; content: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteDTDExternalEntity (writer: xmlTextWriterPtr; pe: Longint; name: xmlCharPtr; pubid: xmlCharPtr; sysid: xmlCharPtr; ndataid: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteDTDExternalEntityContents (writer: xmlTextWriterPtr; pubid: xmlCharPtr; sysid: xmlCharPtr; ndataid: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteDTDInternalEntity (writer: xmlTextWriterPtr; pe: Longint; name: xmlCharPtr; content: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteDTDNotation (writer: xmlTextWriterPtr; name: xmlCharPtr; pubid: xmlCharPtr; sysid: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteElement (writer: xmlTextWriterPtr; name: xmlCharPtr; content: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteElementNS (writer: xmlTextWriterPtr; prefix: xmlCharPtr; name: xmlCharPtr; namespaceURI: xmlCharPtr; content: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteFormatAttribute (writer: xmlTextWriterPtr; name: xmlCharPtr; format: PChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatAttributeNS (writer: xmlTextWriterPtr; prefix: xmlCharPtr; name: xmlCharPtr; namespaceURI: xmlCharPtr; format: PChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatCDATA (writer: xmlTextWriterPtr; format: PChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatComment (writer: xmlTextWriterPtr; format: PChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatDTD (writer: xmlTextWriterPtr; name: xmlCharPtr; pubid: xmlCharPtr; sysid: xmlCharPtr; format: PChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatDTDAttlist (writer: xmlTextWriterPtr; name: xmlCharPtr; format: PChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatDTDElement (writer: xmlTextWriterPtr; name: xmlCharPtr; format: PChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatDTDInternalEntity (writer: xmlTextWriterPtr; pe: Longint; name: xmlCharPtr; format: PChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatElement (writer: xmlTextWriterPtr; name: xmlCharPtr; format: PChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatElementNS (writer: xmlTextWriterPtr; prefix: xmlCharPtr; name: xmlCharPtr; namespaceURI: xmlCharPtr; format: PChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatPI (writer: xmlTextWriterPtr; target: xmlCharPtr; format: PChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatRaw (writer: xmlTextWriterPtr; format: PChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWriteFormatString (writer: xmlTextWriterPtr; format: PChar) : Longint; cdecl; varargs; external LIBXML2_SO;
  function xmlTextWriterWritePI (writer: xmlTextWriterPtr; target: xmlCharPtr; content: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteRaw (writer: xmlTextWriterPtr; content: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteRawLen (writer: xmlTextWriterPtr; content: xmlCharPtr; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteString (writer: xmlTextWriterPtr; content: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatAttribute (writer: xmlTextWriterPtr; name: xmlCharPtr; format: PChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatAttributeNS (writer: xmlTextWriterPtr; prefix: xmlCharPtr; name: xmlCharPtr; namespaceURI: xmlCharPtr; format: PChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatCDATA (writer: xmlTextWriterPtr; format: PChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatComment (writer: xmlTextWriterPtr; format: PChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatDTD (writer: xmlTextWriterPtr; name: xmlCharPtr; pubid: xmlCharPtr; sysid: xmlCharPtr; format: PChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatDTDAttlist (writer: xmlTextWriterPtr; name: xmlCharPtr; format: PChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatDTDElement (writer: xmlTextWriterPtr; name: xmlCharPtr; format: PChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatDTDInternalEntity (writer: xmlTextWriterPtr; pe: Longint; name: xmlCharPtr; format: PChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatElement (writer: xmlTextWriterPtr; name: xmlCharPtr; format: PChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatElementNS (writer: xmlTextWriterPtr; prefix: xmlCharPtr; name: xmlCharPtr; namespaceURI: xmlCharPtr; format: PChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatPI (writer: xmlTextWriterPtr; target: xmlCharPtr; format: PChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatRaw (writer: xmlTextWriterPtr; format: PChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  function xmlTextWriterWriteVFormatString (writer: xmlTextWriterPtr; format: PChar; argptr: va_list) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlThrDefTreeIndentString (v: PChar) : PChar; cdecl; external LIBXML2_SO;
  ...
  function xmlUCSIsBlock (code: Longint; block: PChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlUCSIsCat (code: Longint; cat: PChar) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlURIEscape (str: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlURIEscapeStr (str: xmlCharPtr; list: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlURIUnescapeString (str: PChar; len: Longint; target: PChar) : PChar; cdecl; external LIBXML2_SO;
  function xmlUTF8Charcmp (utf1: xmlCharPtr; utf2: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlUTF8Size (utf: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlUTF8Strlen (utf: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlUTF8Strloc (utf: xmlCharPtr; utfchar: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlUTF8Strndup (utf: xmlCharPtr; len: Longint) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlUTF8Strpos (utf: xmlCharPtr; pos: Longint) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlUTF8Strsize (utf: xmlCharPtr; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlUTF8Strsub (utf: xmlCharPtr; start: Longint; len: Longint) : xmlCharPtr; cdecl; external LIBXML2_SO;
  procedure xmlUnlinkNode (cur: xmlNodePtr); cdecl; external LIBXML2_SO;
  procedure xmlUnlockLibrary (); cdecl; external LIBXML2_SO;
  function xmlUnsetNsProp (node: xmlNodePtr; ns: xmlNsPtr; name: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlUnsetProp (node: xmlNodePtr; name: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidBuildContentModel (ctxt: xmlValidCtxtPtr; elem: xmlElementPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidCtxtNormalizeAttributeValue (ctxt: xmlValidCtxtPtr; doc: xmlDocPtr; elem: xmlNodePtr; name: xmlCharPtr; value: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  function xmlValidGetPotentialChildren (ctree: xmlElementContentPtr; names: xmlCharPtrPtr; len: PInteger; max: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidGetValidElements (prev: xmlNodePtr; next: xmlNodePtr; names: xmlCharPtrPtr; max: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidNormalizeAttributeValue (doc: xmlDocPtr; elem: xmlNodePtr; name: xmlCharPtr; value: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlValidateAttributeValue (type_: xmlAttributeType; value: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlValidateNCName (value: xmlCharPtr; space: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidateNMToken (value: xmlCharPtr; space: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidateName (value: xmlCharPtr; space: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidateNameValue (value: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidateNamesValue (value: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidateNmtokenValue (value: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidateNmtokensValue (value: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlValidateNotationUse (ctxt: xmlValidCtxtPtr; doc: xmlDocPtr; notationName: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidateOneAttribute (ctxt: xmlValidCtxtPtr; doc: xmlDocPtr; elem: xmlNodePtr; attr: xmlAttrPtr; value: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidateOneElement (ctxt: xmlValidCtxtPtr; doc: xmlDocPtr; elem: xmlNodePtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidateOneNamespace (ctxt: xmlValidCtxtPtr; doc: xmlDocPtr; elem: xmlNodePtr; prefix: xmlCharPtr; ns: xmlNsPtr; value: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidatePopElement (ctxt: xmlValidCtxtPtr; doc: xmlDocPtr; elem: xmlNodePtr; qname: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidatePushCData (ctxt: xmlValidCtxtPtr; data: xmlCharPtr; len: Longint) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidatePushElement (ctxt: xmlValidCtxtPtr; doc: xmlDocPtr; elem: xmlNodePtr; qname: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlValidateQName (value: xmlCharPtr; space: Longint) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlXPathCastStringToBoolean (val: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlXPathCastStringToNumber (val: xmlCharPtr) : double; cdecl; external LIBXML2_SO;
  ...
  function xmlXPathCompile (str: xmlCharPtr) : xmlXPathCompExprPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlXPathCtxtCompile (ctxt: xmlXPathContextPtr; str: xmlCharPtr) : xmlXPathCompExprPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlXPathEval (str: xmlCharPtr; ctx: xmlXPathContextPtr) : xmlXPathObjectPtr; cdecl; external LIBXML2_SO;
  procedure xmlXPathEvalExpr (ctxt: xmlXPathParserContextPtr); cdecl; external LIBXML2_SO;
  function xmlXPathEvalExpression (str: xmlCharPtr; ctxt: xmlXPathContextPtr) : xmlXPathObjectPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlXPathFunctionLookup (ctxt: xmlXPathContextPtr; name: xmlCharPtr) : xmlXPathFunction; cdecl; external LIBXML2_SO;
  function xmlXPathFunctionLookupNS (ctxt: xmlXPathContextPtr; name: xmlCharPtr; ns_uri: xmlCharPtr) : xmlXPathFunction; cdecl; external LIBXML2_SO;
  ...
  function xmlXPathIsNodeType (name: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlXPathNewParserContext (str: xmlCharPtr; ctxt: xmlXPathContextPtr) : xmlXPathParserContextPtr; cdecl; external LIBXML2_SO;
  function xmlXPathNewString (val: xmlCharPtr) : xmlXPathObjectPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlXPathNsLookup (ctxt: xmlXPathContextPtr; prefix: xmlCharPtr) : xmlCharPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlXPathRegisterFunc (ctxt: xmlXPathContextPtr; name: xmlCharPtr; f: xmlXPathFunction) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlXPathRegisterFuncNS (ctxt: xmlXPathContextPtr; name: xmlCharPtr; ns_uri: xmlCharPtr; f: xmlXPathFunction) : Longint; cdecl; external LIBXML2_SO;
  function xmlXPathRegisterNs (ctxt: xmlXPathContextPtr; prefix: xmlCharPtr; ns_uri: xmlCharPtr) : Longint; cdecl; external LIBXML2_SO;
  function xmlXPathRegisterVariable (ctxt: xmlXPathContextPtr; name: xmlCharPtr; value: xmlXPathObjectPtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlXPathRegisterVariableNS (ctxt: xmlXPathContextPtr; name: xmlCharPtr; ns_uri: xmlCharPtr; value: xmlXPathObjectPtr) : Longint; cdecl; external LIBXML2_SO;
  ...
  function xmlXPathStringEvalNumber (str: xmlCharPtr) : double; cdecl; external LIBXML2_SO;
  ...
  function xmlXPathVariableLookup (ctxt: xmlXPathContextPtr; name: xmlCharPtr) : xmlXPathObjectPtr; cdecl; external LIBXML2_SO;
  function xmlXPathVariableLookupNS (ctxt: xmlXPathContextPtr; name: xmlCharPtr; ns_uri: xmlCharPtr) : xmlXPathObjectPtr; cdecl; external LIBXML2_SO;
  ...
  procedure xmlXPatherror (ctxt: xmlXPathParserContextPtr; file_: PChar; line: Longint; no: Longint); cdecl; external LIBXML2_SO;
  function xmlXPtrBuildNodeList (obj: xmlXPathObjectPtr) : xmlNodePtr; cdecl; external LIBXML2_SO;
  function xmlXPtrEval (str: xmlCharPtr; ctx: xmlXPathContextPtr) : xmlXPathObjectPtr; cdecl; external LIBXML2_SO;
