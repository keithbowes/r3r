...
Source: "l10n\*"; DestDir: "{app}\includes"; Components: r3r
Source: "rc\*.rc"; DestDir: "{app}\rc"; Components: r3r
Source: "php.ini.gtk"; DestDir:"{app}\php"; Components: php

; Replace by your PHP locations
Source: "C:\Program Files\PHP\cli\php.exe"; DestDir: "{app}\php"; Components: php
Source: "C:\Program Files\PHP\extensions\php_gtk.dll"; DestDir: "{app}\php\extensions"; Components: pg
Source: "C:\Program Files\PHP\extensions\php_gtk_*.dll"; DestDir: "{app}\php\extensions"; Components: pg

; Replace by your system locations
Source: "C:\WINDOWS\system32\php4ts.dll"; DestDir: "{sys}"; Components: php
Source: "C:\WINDOWS\system32\GTK+\lib\*.dll"; DestDir: "{app}\gtk"; Components: gtk
