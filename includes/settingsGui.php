...
function showSettingsDialog()
{
  ...
  if (PHP_GTK_MAJOR > 1)
  {
    $okBtn = $dialog->add_button(SET_OK_BTN, 1);
    $cancelBtn = $dialog->add_button(SET_CANCEL_BTN, 2);
    $saveBtn = $dialog->add_button(SET_SAVE_BTN, 3);

    $dialog->connect('response', 'settingsdlgResponded');
  }
  else
  {
